    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('master.home')}}" class="nav-link">Home</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li>
                        <a href="{{route('master.orders.index')}}" class="nav-link">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>Заказы</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('master.category.create')}}" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="{{route('master.product.index')}}" class="nav-link">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('master.product.create')}}" class="nav-link">
                                    <p>Добавить товар</p>
                                </a>
                            </li>
